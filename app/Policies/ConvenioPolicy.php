...
class ConvenioPolicy
{
    ...
    {
        return $user->can('delete_any_convenio');
    }

    /**
     * Determine whether the user can permanently delete.
     */
    public function forceDelete(User $user, Convenio $convenio): bool
    {
    ...
    {
        return $user->can('force_delete_any_convenio');
    }

    /**
     * Determine whether the user can restore.
     */
    public function restore(User $user, Convenio $convenio): bool
    {
    ...
    {
        return $user->can('restore_any_convenio');
    }

    /**
     * Determine whether the user can replicate.
     */
    public function replicate(User $user, Convenio $convenio): bool
    {
        return $user->can('replicate_convenio');
    }
    ...
    {
        return $user->can('reorder_convenio');
    }
}
